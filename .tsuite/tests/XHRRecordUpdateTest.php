<?php
    ...
    function test_update_record_get_record_1($properties) {
        ...
        $response = test_curl($properties['endpoint_url'] . '/xhr/record_update', array('record_name' => 'test', 'fields' => '{"t3":{"value":"7","type":"TEXT"}}', 'criteria' => '{"id":{"value":"1","type":"INT"}}'), true, $session_token);
