<?php
    ...
    function xhr_new_audit(&$data) {
        ...
        try {
            ...
            if(!isset($audit_data) || sizeof($audit_data) == 0) {
                $response['xhr_response_status'] = 'error';
                $response['error'] = 'audit_data is not set or is blank';
            ...
            if(!isset($audit_data['raw_state']) || sizeof($audit_data['raw_state']) == 0) {
                $response['xhr_response_status'] = 'error';
                $response['error'] = 'audit_data raw_state is not set or is blank';
            ...
            if(isset($audit_data['raw_state']) && isset($audit_data['raw_state']['_CMS']) && isset($audit_data['raw_state']['_CMS']['path'])) {
